...
- **Roboto-Medium** - Peso médio da fonte (500) - Usada como fonte principal
- **Roboto-Bold** - Peso negrito da fonte (700)
- **Roboto-Light** - Peso leve da fonte (300)
- **Roboto-Thin** - Peso fino da fonte (100)
- **Roboto-ExtraLight** - Peso extra leve da fonte (200)
- **Roboto-Black** - Peso preto da fonte (900)
- **Roboto-SemiBold** - Peso semi-negrito da fonte (600)
- **Roboto-ExtraBold** - Peso extra negrito da fonte (800)
...
const styles = StyleSheet.create({
  title: {
    fontFamily: Constants.styles.fontFamily.MAIN, // Roboto-Medium
